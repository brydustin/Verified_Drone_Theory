...
## 1. Project statistics — snapshot (as of 2026-06-05)
...
| Metric | Value | Status |
|---|---:|---|
| **Theory (.thy) files** | 24 | grows |
| **Lines of code (total / non-blank)** | 25,308 / 22,499 | grows |
| **Theorems** | 45 | grows |
| **Lemmas** | 873 | grows |
| **Corollaries / Propositions** | 53 | grows |
| **Definitions** | 163 | grows |
| **sorry's remaining (total)** | 26 | → 0 at completion |
| &nbsp;&nbsp;of which on the `F0_dip_nonempty` path | 10 | → 0 at completion |
